    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="social-modal-wrap">
          ...
          <a href="#">
            <img src="<?php echo get_template_directory_uri(); ?>/img/social-modal-02.svg" alt="Facebook">
          </a>
          <a href="#">
            <img src="<?php echo get_template_directory_uri(); ?>/img/social-modal-03.svg" alt="Facebook">
          </a>
          <a href="#">
            <img src="<?php echo get_template_directory_uri(); ?>/img/social-modal-04.svg" alt="Facebook">
          </a>
          <a href="#">
            <img src="<?php echo get_template_directory_uri(); ?>/img/social-modal-05.svg" alt="Facebook">
          </a>
          <a href="#">
            <img src="<?php echo get_template_directory_uri(); ?>/img/social-modal-06.svg" alt="Facebook">
          </a>
      ...
      <div class="modal-body">
        ...
        <div class="container">
          ...
          <div class="col-md-6">
            <a href="#" class="modal-menu-btn-link">
            ...
            <input type="text" class="search-modal" placeholder="Search"/>
          </div>
